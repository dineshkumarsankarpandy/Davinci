    ...
    <Dialog onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-md" style={{ maxWidth: "400px", marginLeft:'575px' }}>
        ...
        <DialogClose asChild>
          <button
            onClick={handleSave}
            className="w-full mt-4 py-3 font-medium text-white bg-indigo-600 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
            Save
          </button>
        </DialogClose>
